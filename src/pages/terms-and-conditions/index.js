  ...
  return (
    <>
      ...
      >
        ...
        <br></br>
        <Text span>Welcome to INOVAUD!</Text>
        <Text span>
          These terms and conditions outline the rules and regulations for the
          use of INOVAUD&apos;s Website, located at https://inovaud.com.
        </Text>
        <Text span>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use INOVAUD if you do not agree to take
        ...
        <Text span>
          ...
          prevailing law of lt. Any use of the above terminology or other words
        ...
        <Text span>
          We employ the use of cookies. By accessing INOVAUD, you agreed to use
          cookies in agreement with the INOVAUD&apos;s Privacy Policy.{" "}
        </Text>
        <Text span>
        ...
        <Text span>
          Unless otherwise stated, INOVAUD and/or its licensors own the
          intellectual property rights for all material on INOVAUD. All
          intellectual property rights are reserved. You may access this from
          INOVAUD for your own personal use subjected to restrictions set in
          these terms and conditions.
        </Text>
        <Text span>You must not:</Text>
        <ul>
          <li>- Republish material from INOVAUD</li>
          <li>- Sell, rent or sub-license material from INOVAUD</li>
          <li>- Reproduce, duplicate or copy material from INOVAUD</li>
          <li>- Redistribute content from INOVAUD</li>
        </ul>
        <Text span>
        ...
        <Text span>
          ...
          INOVAUD does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of INOVAUD,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, INOVAUD shall not be liable
        ...
        <Text span>
          INOVAUD reserves the right to monitor all Comments and to remove any
          Comments which can be considered inappropriate, offensive or causes
          breach of these Terms and Conditions.
        </Text>
        <Text span>You warrant and represent that:</Text>
        <ul>
          <li>
        ...
        <Text span>
          You hereby grant INOVAUD a non-exclusive license to use, reproduce,
        ...
        <Text span>
          ...
          sending an e-mail to INOVAUD. Please include your name, your
        ...
        <Text span>
          No use of INOVAUD&apos;s logo or other artwork will be allowed for
